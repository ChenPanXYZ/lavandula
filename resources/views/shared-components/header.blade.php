...
<header class="site-header" id="header">
    <div class = "signature" id = "my_signature">
        <p><span> <img width = "16px" height = "16px" id = "topnav-logo" src='/android-chrome-20x20.png' alt='Pan Chen'> </span><span id = "nav-signature"><?php echo __("Pan Chen"); ?></span></p>
    </div>
    <nav class="topnav" id="topnav">
        ...
        <?php echo __('<a href = "/blog" aria-label="Blog" onclick="header.adjust()" rel="noopener">Blog</a>'); ?>
        <a href = "/#projects" aria-label="Projects" onclick="header.adjust()" rel="noopener"><?php echo __("Projects"); ?></a>
        <a href = "/#skills" aria-label="My Skills" onclick="header.adjust()" rel="noopener"><?php echo __("Skills"); ?></a>
    ...
    <div id="myModal" class="modal" style = "display: none;">
        ...
        <div class="languages modal-content" id = "modal-content">
            ...
            <a class = "language-switcher" href = "{{$languageUrls[2]}}" onclick="setLanguage('zh-TW', '{{$domain}}')" aria-label="Traditional Chinese Version" rel="noopener">正體中文</a>
        </div>

    </div>

    <div id = "info">
        <h1 id = "name"><?php echo __("Pan Chen"); ?></h1>
